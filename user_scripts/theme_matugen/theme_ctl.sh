...
#
# Architecture:
#   1. INTERNAL STATE: Reads/Writes to ~/.config/shoonya/settings/shoonya_theme/state.conf
#   2. PUBLIC STATE:   Writes 0/1 state to ~/.config/shoonya/settings/shoonya_theme/state
...
# --- CONFIGURATION ---
readonly STATE_DIR="${HOME}/.config/shoonya/settings/shoonya_theme"
